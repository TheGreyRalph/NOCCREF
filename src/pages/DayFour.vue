        ...
        >
          <div class="flex flex-col gap-y-4 items-center justify-center">
            <p class="text-white text-4xl text-center font-lora font-semibold">
              Music and Fashion Night
            </p>
            <p class="text-white w-[55%] text-center">
              This event brings together talented musicians and artists to
              create an unforgettable experience that highlights the diversity
              of Northern Nigerian culture.
            </p>
            <div
    ...
    <q-intersection :transition-duration="600" transition="scale" once>
      <div class="px-20 mt-10">
        <q-timeline color="secondary" layout="comfortable" side="right">
          ...
          <q-timeline-entry
            title="Live music performances by Nigerian
 A-List Artistes and Northern Nigerian Stars
 and Dance Performances"
            subtitle="May 15, 2025"
          />
          <q-timeline-entry
            title="Fashion show featuring Northern Nigerian fashion designers and global brands
 like Dior, Chanel, Louis Vuitton, Gucci,
 Zara, Ralph Lauren, Prada etc. "
            subtitle="May 15, 2025"
          />
          <q-timeline-entry
            title="Cultural display of Northern Nigerian
...
<style lang="scss">
.hero-entry {
  background: url("../assets/noccref/APNBWUP4A5HJHPUOC7ZYWSQHI4.jpg") no-repeat
    top center/cover;
}
