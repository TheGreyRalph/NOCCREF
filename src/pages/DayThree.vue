        ...
        >
          <div class="flex flex-col gap-y-4 items-center justify-center">
            ...
            <p class="text-white w-[55%] text-center">
              Creatives Fair is a platform for creatives to showcase their work,
              network with industry professionals, and gain valuable insights
              into the creative industry. The event features workshops, panel
              discussions, and exhibitions from leading creatives in various
              fields.
            </p>
            <div
    ...
    <q-intersection :transition-duration="600" transition="scale" once>
      <div class="px-20 mt-10">
        <q-timeline color="secondary" layout="comfortable" side="right">
          ...
          <q-timeline-entry
            title="Exhibition of artworks and creative
 products by local artisans"
            subtitle="May 14, 2025"
          />
          <q-timeline-entry
            title=" Networking opportunities for creatives
 and potential investors"
            subtitle="May 14, 2025"
          />
          <q-timeline-entry
            title="Live demonstrations of creative
 processes by artists"
            subtitle="May 14, 2025"
          />
        </q-timeline>
      </div>
...
<style lang="scss">
.hero-entry {
  background: url("../assets/noccref/Igabi_Maraba_Pottery_02_IMG_0735.jpg")
